...
\begin{tabular}{rl}
  DSR & Pesquisa em Design Science (\emph{Design Science Research})\\
   ...
   WCAG & Diretrizes de Acessibilidade para Conteúdo Web (\emph{Web Content Accessibility Guidelines})\\
