...
Agradeço aos meus colegas do BCC, pela amizade, colaborações e aprendizados e pelos momentos de descontração que tornaram a graduação mais divertida. Aos professores e mentores, que nos promoveram oportunidades de crescimento pessoal e profissional. Em particular, ao meu primeiro mentor, João Daniel, que me apresentou oficialmente ao incrível mundo da Engenharia de \textit{Software} e me ensinou os primeiros passos dentro dela. Ao professor Alfredo Goldman, que me ensinou que \enquote{\textit{software} é sobre pessoas}. Uma lição importante que vivenciei e que levarei para a minha carreira.
...
\pagestyle{mainmatter}
\input{conteudo/01-ferramentas}
\input{conteudo/02-metodologia}
\input{conteudo/03-prototipos}
\input{conteudo/04-desenvolvimento}
\input{conteudo/05-avaliacao}
\input{conteudo/06-resultados.tex}
