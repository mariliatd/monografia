...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.55]{likert_com_conhecimento.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.55]{likert_sem_conhecimento.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.65]{radar_medias.png}
...
\addcontentsline{toc}{section}{\protect\numberline{}Opiniões e sugestões sobre a simulação}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.6]{formulario_livre_1.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.6]{formulario_livre_2.png}
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.6]{formulario_livre_3.png}
